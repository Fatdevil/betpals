...
import { formatCurrency, formatDeadline, showToast, launchConfetti, escapeHtml, sanitizeUrl, getAppBaseUrl, parseServerDate } from '../utils.js';
            ...
            <div class="photo-header flex-between mb-sm" style="align-items: center;">
              <div class="flex" style="align-items: center; gap: 8px;">
                ...
                <div>
                  ...
                  <div class="text-muted" style="font-size: 0.7rem;">${parseServerDate(p.createdAt).toLocaleString('sv-SE', {day: 'numeric', month: 'short', hour: '2-digit', minute:'2-digit'})}</div>
                </div>
              </div>
